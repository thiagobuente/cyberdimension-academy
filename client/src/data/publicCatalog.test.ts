...
describe("public catalog composition", () => {
  it("mantém as quatro formações ORBIT ao lado dos cursos curriculares disponíveis", () => {
    ...
    expect(publicCatalogGroups.curriculumCourses).toHaveLength(67);
    expect(publicCatalogGroups.curriculumCourses.filter((course) => course.level === "Avançado")).toHaveLength(13);
