...
export default function FormationStudy() {
  ...
  const [authorialVideoLoadError, setAuthorialVideoLoadError] = useState(false);
  ...
  const authorialVideoPanelRef = useRef<HTMLElement>(null);
  ...
  useEffect(() => {
    setAuthorialVideoLoadError(false);
  }, [courseSlug, selectedAuthorialVideo]);
  ...
  const handleAuthorialVideoSelect = (index: number) => {
    ...
    setTimeout(() => authorialVideoPanelRef.current?.scrollIntoView({ behavior: "smooth", block: "center" }), 0);
  };
