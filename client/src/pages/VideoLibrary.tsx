...
export default function VideoLibrary() {
  ...
  const videoCourses = useMemo(() => functionalCourses.filter((course) => Boolean(course.videoLearning)), []);
